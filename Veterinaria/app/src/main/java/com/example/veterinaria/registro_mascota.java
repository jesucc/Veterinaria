...
public class registro_mascota extends AppCompatActivity {
    ...
    final String URL = "http://192.168.0.106/Veterinariaj/controllers/veterinaria.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        razasMap.put("pitbul", 1);
        razasMap.put("pequeñes", 2);
    ...
    private void registrarMascota(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("operacion", "mascotaRegistrar");
